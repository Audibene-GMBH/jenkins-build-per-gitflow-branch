...
class JenkinsJobManager {
	...
	String featureSuffix = "feature/WEB-"
	String hotfixSuffix = "hotfix/v"
	String releaseSuffix = "release/v"
	...
	public void syncJobs(List<String> allBranchNames, List<String> jobNames, List<TemplateJob> templateJobs) {
		...
		templateJobsByBranch.keySet().each { templateBranchToProcess ->
			...
			List<String> deleteCandidates = jobNames.findAll {  it.contains(branchSuffixMatch[templateBranchToProcess].replaceAll('/', '_')) }
